  ...
  return (
    <div className="t-logo">
      <svg width="26" height="26" viewBox="0 0 26 26" fill="none" aria-hidden="true">
        <circle cx="13" cy="13" r="11" stroke="#B3B060" strokeWidth="1.6" opacity="0.5" />
        <circle cx="13" cy="13" r="4.5" fill="#B3B060" />
      </svg>
      <span>TRACE</span>
    </div>
  )
        ...
        <div className="attest-footer">
          <span className="verified-badge">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M2 7l3.2 3.2L12 3.4" stroke="#406B54" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Verified
          </span>
